...
int main(int argc, char* argv[]) {
	...
	openstream(&__in, "\\\\.\\pipe\\libinteractive_ColaInteractivo_ColaInteractivo_in", O_RDONLY);
	openstream(&__out, "\\\\.\\pipe\\libinteractive_ColaInteractivo_ColaInteractivo_out", O_WRONLY);
